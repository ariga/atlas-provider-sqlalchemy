-- atlas:pos user_account[type=table] [ABS_PATH]/tests/structured_models/models/user.py:7
-- atlas:pos address[type=table] [ABS_PATH]/tests/structured_models/models/user.py:20
